...
class MemoryType(Enum):
    ...
    ADAPTIVE_TRAJECTORY_KNOWLEDGE = "adaptive_trajectory_knowledge"
    ECHO_BASE = "echo_base"
...
PROVIDER_MAPPING = {
    ...
    MemoryType.PATHFINDER: ("PathfinderProvider", "pathfinder_provider"),
    MemoryType.ADAPTIVE_TRAJECTORY_KNOWLEDGE: ("AdaptiveTrajectoryKnowledgeProvider", "adaptive_trajectory_knowledge_provider"),
    MemoryType.ECHO_BASE: ("EchoBaseProvider", "echo_base_provider"),
