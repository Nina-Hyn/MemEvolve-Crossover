...
DEFAULT_CONFIG = {
    ...
    "providers": {
        ...
        MemoryType.PATHFINDER: {
            "db_path": './storage/pathfinder/pathfinder_memory.json',
            "model": "",
            "embedding_model": 'sentence-transformers/all-MiniLM-L6-v2',
            "model_cache_dir": './storage/models',
            "top_k_begin": 3,
        ...
        MemoryType.ADAPTIVE_TRAJECTORY_KNOWLEDGE: {
            "db_path": './storage/adaptive_trajectory_knowledge/memory_store.json',
            "embedding_model": 'sentence-transformers/all-MiniLM-L6-v2',
            "embedding_cache": './storage/models',
            "top_k": 3,
            "max_memories": 500,
            "field_weights": {'query': 0.5, 'plan': 0.3, 'experience': 0.2},
            "dedup_threshold": 0.95,
            "recency_weight": 0.2,
            "utility_weight": 0.3
        },
        MemoryType.ECHO_BASE: {
            "db_path": './storage/echo_base/echo_memory.json',
            "embedding_model_name": 'sentence-transformers/all-MiniLM-L6-v2',
            "embedding_model_cache": './storage/models',
            "top_k_begin": 3,
            "top_k_in": 2,
            ...
            "weights_begin": {'query': 0.6, 'planning': 0.3, 'experience': 0.1},
            "weights_in": {'query': 0.1, 'planning': 0.2, 'experience': 0.7}
        },
